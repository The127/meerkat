...
<template>
  ...
  >
    ...
    >
      <div
        :class="[
          'absolute right-0 w-80 rounded-md px-4 py-3 shadow-lg transition-all duration-200',
          styles[toast.type],
        ]"
        :style="{
      ...
      >
        <div class="flex items-start gap-2.5">
          ...
          <button
            class="shrink-0 rounded-sm p-0.5 opacity-60 transition-opacity hover:opacity-100 cursor-pointer"
        ...
        <div class="absolute bottom-0 left-0 h-0.5 w-full overflow-hidden rounded-b-md">
          <div
